以下、私のObsidianのメモをコピーしたもの。

---

いずれはAB-SFCモデルづくりにつなげたい

# 消費と資本について名目変数のみの集計的モデル
[[SFCモデルの、行動方程式についてのアイデアをメモする場所]]

このアイデアを取り込んだ、閉鎖経済の集計的SFCモデルを作る。
まだプロトタイプもできていない
...
|         | 期首        | フロー               | キャピタルゲイン                  | 期末    |
| ------- | --------- | ----------------- | ------------------------- | ----- |
| 資本      | $K_{-1}$  | $I-\delta K_{-1}$ |                           | $K$   |
| 労働者預金   | $M_{w-1}$ | $\Delta M_w$      |                           | $M_w$ |
| 投資家預金   | $M_{i-1}$ | $\Delta M_i$      |                           | $M_i$ |
| 企業預金    | $M_{f-1}$ | $\Delta M_f$      |                           | $M_f$ |
| 金融機関預金  | $M_{-1}$  | $\Delta M$        |                           | $M$   |
| 労働者貸付金  | $L_{w-1}$ | $\Delta L_w$      |                           | $L_w$ |
| 企業貸付金   | $L_{f-1}$ | $\Delta L_f$      |                           | $L_f$ |
| 金融機関貸付金 | $L_{-1}$  | $\Delta L$        |                           | $L$   |
| 投資家株式   | $E_{i-1}$ | $p_E\Delta e_i$   | $\Delta p_E\cdot e_{i-1}$ | $E_i$ |
| 金融機関株式  | $E_{b-1}$ | $p_E\Delta e_b$   | $\Delta p_E\cdot e_{b-1}$ | $E_b$ |
| 企業株式    | $E_{-1}$  |                   | $\Delta p_E\cdot e_{-1}$  | $E$   |
| 現金      | $H_{-1}$  | $\Delta H$        |                           | $H$   |
| 投資家国債   | $B_{i-1}$ | $p_B\Delta b_i$   | $\Delta p_B\cdot b_{i-1}$ | $B_i$ |
| 金融機関国債  | $B_{b-1}$ | $p_B\Delta b_b$   | $\Delta p_B\cdot b_{b-1}$ | $B_b$ |
| 統合政府国債  | $B_{-1}$  | $p_B\Delta b$     | $\Delta p_B\cdot b_{-1}$  | $B$   |

## ストックの増減の整合性を表す表
|             | 労働者           | 投資家                        | 企業                        | 金融機関                       | 統合政府                      |
| ----------- | ------------- | -------------------------- | ------------------------- | -------------------------- | ------------------------- |
| 期首純資産       | $NW_{w-1}$    | $NW_{i-1}$                 | $NW_{f-1}$                | $NW_{b-1}$                 | $NW_{g-1}$                |
| 資本の増減       |               |                            | $+I-\delta K_{-1}$        |                            |                           |
| 預金の増減       | $+\Delta M_w$ | $+\Delta M_i$              | $+\Delta M_f$             | $-\Delta M$                |                           |
| 貸付金の増減      | $-\Delta L_w$ |                            | $-\Delta L_f$             | $+\Delta L$                |                           |
| 株式のキャピタルゲイン |               | $+\Delta p_E\cdot e_{i-1}$ | $-\Delta p_E\cdot e_{-1}$ | $+\Delta p_E\cdot e_{b-1}$ |                           |
| 株式の売買       |               | $+p_E\Delta e_i$           |                           | $+p_E\Delta e_b$           |                           |
| 現金の増減       |               |                            |                           | $+\Delta H$                | $-\Delta H$               |
| 国債のキャピタルゲイン |               | $+\Delta p_B\cdot b_{i-1}$ |                           | $+\Delta p_B\cdot b_{b-1}$ | $+\Delta p_B\cdot b_{-1}$ |
| 国債の売買       |               | $+p_B\Delta b_i$           |                           | $+p_B\Delta b_b$           | $+p_B\Delta b$            |
...
https://github.com/rokaboNatttsu/SFC_8?tab=readme-ov-file

ここのA.jlで実装済

# 資本の実物量を必要な労働で定義する、価格を導入した集計的なSFCモデル
[[SFCモデルの、行動方程式についてのアイデアをメモする場所]]

[[資本の実物量をそれを維持し適切な稼働率で動かすために必要な労働量で定義するマクロ経済の理論モデルというアイデア]]

この二つをもとに作る

あと、国債と貸付金の金利を内生的に決定する
